...
const NewsLatterBox = () => {
  ...
  return (
    <div className="shadow-three dark:bg-gray-dark relative z-10 rounded bg-white p-8 sm:p-11 lg:p-8 xl:p-11">
      ...
      <div>
        <input
          ...
          className="border-stroke text-body-color focus:border-primary dark:text-body-color-dark dark:shadow-two dark:focus:border-primary mb-4 w-full rounded border bg-[#f8f8f8] px-6 py-3 text-base outline-none dark:border-transparent dark:bg-[#2C303B] dark:focus:shadow-none"
        />
        <input
          type="email"
          name="email"
        ...
        <input
          type="submit"
          value="Subscribe"
          className="bg-primary shadow-submit hover:bg-primary/90 dark:shadow-submit-dark mb-5 flex w-full cursor-pointer items-center justify-center rounded px-9 py-4 text-base font-medium text-white duration-300"
        />
