import { Blog } from "@/startup-template/types/blog";
...
const SingleBlog = ({ blog }: { blog: Blog }) => {
  ...
  return (
    <>
      <div className="group shadow-one hover:shadow-two dark:bg-dark dark:hover:shadow-gray-dark relative overflow-hidden rounded bg-white duration-300">
        <Link
          href="/blog-details"
